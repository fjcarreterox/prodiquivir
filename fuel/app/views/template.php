...
<header></header>
	<div class="container">
		<div class="col-md-12 cabecera">
            ...
            <a alt="Ir al menú principal" href="http://gestion.aceitunascoria.es/fuel/public/" class="no-decoration"><?php echo Asset::img('aceitunas.jpg',array("class"=>"logo","alt"=>"Ir al menú principal")); ?>
